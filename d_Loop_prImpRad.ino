...
// PILOTAGGIO DEI LED:
  ...
  if(LED==0)               PORTC&=B11000000;
    ...
    {
    if     (Rad>soglia5) {PORTC&=B11100001; PORTC|=B00111110;}
    else if(Rad>soglia4) {PORTC&=B11010001; PORTC|=B00011110;}
    ...
    {
    if     (Rad>soglia5) {PORTC&=B11100000; PORTC|=B00111110;}
    else if(Rad>soglia4) {PORTC&=B11010000; PORTC|=B00011110;}
