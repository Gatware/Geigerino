...
// PILOTAGGIO DEI LED:
  ...
  if(LED==0)               PORTC&=B11000000;
    ...
    {
    if     (Rad>soglia5) {PORTC&=B11100001; PORTC|=B00111110; tone(7, 1000, 2000);}
    else if(Rad>soglia4) {PORTC&=B11010001; PORTC|=B00011110; tone(7, 1000, 1000);}
    else if(Rad>soglia3) {PORTC&=B11001001; PORTC|=B00001110;}
    else if(Rad>soglia2) {PORTC&=B11000101; PORTC|=B00000110;}
    else if(Rad>soglia1) {PORTC&=B11000011; PORTC|=B00000010;}
    else                  PORTC&=B11000001;
    }
  else if(LED==2)
    {
    if     (Rad>soglia5) {PORTC&=B11100000; PORTC|=B00111110; tone(7, 1000, 2000);}
    else if(Rad>soglia4) {PORTC&=B11010000; PORTC|=B00011110; tone(7, 1000, 1000);}
    else if(Rad>soglia3) {PORTC&=B11001000; PORTC|=B00001110;}
    else if(Rad>soglia2) {PORTC&=B11000100; PORTC|=B00000110;}
