...
Se il tempo è impostato su "Precisione fissa", il conteggio va avanti finché l'errore scende al di sotto del valore impostato. Contemporaneamente viene visualizzato il tempo stimato rimanente al raggiungimento della precisione impostata. Premendo l'encoder, si torna alla visualizzazione dei uSv/h e del tempo trascorso. Raggiunta la precisione impostata, inizia un suono intermittente e il conteggio si ferma. Premendo l'encoder il suono viene tacitato e compare il tempo effettivamente trascorso. Premendolo nuovamente, i conteggi si azzerano. 
