...
Premendo di nuovo l'encoder vengono visualizzate la versione e la data di aggiornamento.
Premendolo di nuovo, Geigerino si avvia.
...
Se il tempo è impostato su "Precisione fissa", il conteggio va avanti finché l'errore scende fino al valore impostato. Durante il conteggio viene visualizzato il tempo stimato rimanente al raggiungimento della precisione impostata, evidenziato con "-". Premendo l'encoder, si torna alla visualizzazione dei uSv/h e del tempo trascorso, evidenziato con un "+". Raggiunto l'errore impostato, il conteggio si ferma e inizia un suono intermittente. Premendo l'encoder il suono si interrompe e viene visualizzato il tempo trascorso. Premendo nuovamente l'encoder, il conteggio si azzera e ricomincia.
