...
if(Ti<Tio) lcd.setCursor(5,1); lcd.print("ZERO"); // Se il tempo impostato è minore del precedente, segnala che azzera.
if(Ti!=EEPROM.read(0)) {EEPROM.update(0,Ti); Biip(); lcd.setCursor(12,1); lcd.print(" SET!"); delay(500);}
else Bip();
